    ...
    if (isAstObject(astObject)) {
        ...
        switch (astObject.concept) {
            ...
            case "Attribute Reference": {
                ...
                return <AstObjectUiWrapper className="inline" astObject={astObject}>
            ...
            case "Data Attribute": return <AstObjectUiWrapper className="attribute" astObject={astObject}>
                <span className="keyword ws-right">the</span>
            ...
            case "Record Type": return <AstObjectUiWrapper astObject={astObject}>
                <div>
