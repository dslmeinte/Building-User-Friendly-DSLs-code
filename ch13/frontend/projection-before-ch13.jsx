...
export const Projection = observer(({ value, setValue, ancestors }) => {    // FIXME back-propagate deleteValue -> setValue !!!
    if (isAstObject(value)) {
        ...
        const UiWrapped = ({ className, children, sideTransformable }) => <AstObjectUiWrapper
                className={className}
        ...
        switch (value.concept) {
            ...
            case "Number": {
                ...
                return <UiWrapped className="inline" sideTransformable>
                    ...
                    {attributeType === "period in days" && <span className="keyword whitespace-left">days</span>}
               </UiWrapped>
            }

            case "Parentheses": return <UiWrapped className="inline" sideTransformable>
